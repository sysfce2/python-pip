...
def _set_platform_dir_class() -> type[PlatformDirsABC]:
    if os.getenv("ANDROID_DATA") == "/data" and os.getenv("ANDROID_ROOT") == "/system":
        ...
        from pip._vendor.platformdirs.android import _android_folder  # ruff:ignore[import-outside-top-level]

        if _android_folder() is not None:
            from pip._vendor.platformdirs.android import Android  # ruff:ignore[import-outside-top-level]
